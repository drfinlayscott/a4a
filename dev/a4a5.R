###############################################################################
# EJ(20111212)
# A4A assessment model 5 (now with sel functions): 
#	Type: Separable SCAA 
#	Data:
#		catch-at-age
...
#	Isel = q*sel
#	sel = age^a*exp(-b*age))/(max(age^a*exp(-b*age)) - normalized beta
###############################################################################

#==============================================================================
# Generic
#==============================================================================
setGeneric('a4a5', function(stk, idx, ...){standardGeneric('a4a5')})
